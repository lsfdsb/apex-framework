...
import {
  ...
  ShieldCheck, Rocket, Paintbrush, Bug, X, Lock, Palette,
  ChevronDown, User,
} from "lucide-react";
...
const SUB_PROJECTS: SubProject[] = [
  ...
  },
  {
    ...
    teamTasks: [
      ...
      { id: "T-4", title: "QA pass", stage: "quality", dri: "QA", done: false },
      { id: "T-5", title: "Security review", stage: "security", dri: "QA", done: false },
    ],
  },
  {
    ...
    teamTasks: [
      ...
      { id: "R-2", title: "Vector embeddings pipeline", stage: "build", dri: "Builder", done: false },
      { id: "R-3", title: "Edge function endpoints", stage: "build", dri: "Builder", done: false },
      { id: "R-4", title: "Retrieval accuracy tests", stage: "quality", dri: "QA", done: false },
      { id: "R-5", title: "API key rotation + RLS", stage: "security", dri: "QA", done: false },
    ],
  },
];
...
function KanbanTaskCard({ task }: { task: TeamTask }) {
  ...
  return (
    <div style={{
      ...
      {/* Drawer — expanded detail */}
      {open && (
        <div style={{
          borderTop: "1px solid var(--border)", padding: "8px 10px",
          background: "var(--bg-surface, var(--bg))", fontSize: 10,
        }}>
