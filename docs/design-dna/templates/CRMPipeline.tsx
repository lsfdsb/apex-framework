...
const stages = [
  ...
  {
    name: 'Won',
    color: 'var(--pipeline-won,#34d399)',
    count: 1,
    deals: [{ name: 'Analytics Suite', company: 'InsightCo', amount: '$52,000', initials: 'IC' }],
  },
  {
    name: 'Lost',
    color: 'var(--pipeline-lost,#f87171)',
    count: 1,
    deals: [{ name: 'Legacy System', company: 'OldTech', amount: '$15,000', initials: 'OT' }],
  },
];
const contacts = [
  {
...
const timeline = [
  {
    time: '2 hours ago',
    text: '<strong>Ana Souza</strong> moved "API Integration" to Qualified',
    active: true,
  },
  {
    time: 'Yesterday',
    text: '<strong>Marcus Chen</strong> added note on "Dashboard MVP"',
    active: false,
  },
  {
    time: '2 days ago',
    text: 'New lead: <strong>Brand Identity</strong> from Lumina ($8,500)',
    active: false,
  },
  {
    time: '3 days ago',
    text: '<strong>Julia Park</strong> won "Analytics Suite" — $52,000',
    active: false,
  },
...
const tickets = [
  {
    ...
    desc: "User can't access account on iOS 17",
    priority: 'high',
    status: 'open',
    time: '12m ago',
  },
  {
    ...
    desc: 'Dashboard export returns empty file',
    priority: 'medium',
    status: 'pending',
    time: '2h ago',
  },
  {
    ...
    desc: 'Text hard to read on sidebar',
    priority: 'low',
    status: 'resolved',
    time: '1d ago',
  },
    ...
    <div style={{ color: 'var(--text)', fontFamily: 'var(--font-body)', position: 'relative' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="reveal reveal-delay-1">
            ...
            <p style={{ fontSize: 17, color: 'var(--text-secondary)', fontWeight: 300 }}>
              Patterns for apps that manage people, deals, and conversations.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '100px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div
            className="crm-pipeline reveal reveal-delay-1"
              ...
              >
                ...
                {s.deals.map((d) => (
                  <div
                    key={d.name}
                    className="crm-deal"
                    style={s.name === 'Lost' ? { opacity: 0.5 } : undefined}
                  >
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            {contacts.map((c, i) => (
              <div
                key={c.name}
                className={`crm-contact reveal${i > 0 ? ` reveal-delay-${i}` : ''}`}
              >
                <div
                  style={{
                    width: 64,
                ...
                >
                  ...
                  <span style={{ fontSize: 20, fontWeight: 600, color: c.color }}>
                    {c.initials}
                  </span>
                </div>
                <div
      ...
      <section style={{ padding: '100px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div
            className="crm-split reveal reveal-delay-1"
            style={{
              display: 'grid',
          ...
          >
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      zIndex: 1,
                      transition: 'all .3s',
                      boxShadow: t.active ? '0 0 0 4px var(--accent-glow)' : 'none',
                    }}
                  />
                  <div
                    style={{
            ...
            >
              ...
              >
                ...
                />
                <div>
                  <h4 style={{ fontSize: 14, fontWeight: 600 }}>Support Chat</h4>
                  <p style={{ fontSize: 11, color: 'var(--text-muted)' }}>Ana is online</p>
                </div>
              </div>
              <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                >
                  Hi! I need help with the API integration.
                </div>
                <div
                  style={{
                    maxWidth: '80%',
                ...
                >
                  Sure! Let me pull up your account details.
                </div>
                <div
                  style={{
                    maxWidth: '80%',
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            {tickets.map((t, i) => (
              <div
                key={t.title}
                className={`crm-ticket reveal${i > 0 ? ` reveal-delay-${i}` : ''}`}
              >
                <div
                  style={{
                    width: 4,
      ...
      <section style={{ padding: '100px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="reveal">
            ...
            >
              Comunique-se em qualquer canal.
            </h2>
          </div>
          <div className="reveal reveal-delay-1">
            <Sender />
      ...
      <section style={{ padding: '100px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="reveal">
            ...
            >
              Sidebar flutuante + barra superior. O layout respira com o background.
            </p>
          </div>
          <div
          ...
          >
            <AppShell>
              <TopBar
                title="Dashboard"
                breadcrumbs={[{ label: 'CRM' }, { label: 'Visão Geral' }]}
              />
              <div
                style={{
              ...
              >
                <div style={{ textAlign: 'center', color: 'var(--text-muted)' }}>
                  ...
                  <p style={{ fontSize: 12, marginTop: 8 }}>
                    Sidebar à esquerda · Barra superior flutuante
                  </p>
                </div>
              </div>
            </AppShell>
