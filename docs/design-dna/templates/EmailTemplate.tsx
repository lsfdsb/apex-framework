    ...
    <div className="em-frame">
      ...
      >
        <div style={{ marginBottom: 4 }}>
          <strong style={{ color: 'var(--text-secondary)' }}>From:</strong> {de}
        </div>
        <div>
          <strong style={{ color: 'var(--text-secondary)' }}>Subject:</strong> {assunto}
        </div>
      </div>
      <div style={{ background: 'var(--bg)' }}>
        <div className="em-inner" style={{ maxWidth: 560, margin: '0 auto', padding: '40px 32px' }}>
          {children}
        </div>
      </div>
    </div>
...
function Logo() {
  return (
    <div style={{ fontSize: 16, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 32 }}>
...
function Rodape({ extra }: { extra?: string }) {
  return (
    ...
    >
      {extra || 'Você está recebendo este e-mail porque se cadastrou em apex.io.'}
      <br />
      <a href="#" style={{ color: 'var(--text-muted)', textDecoration: 'underline' }}>
        Cancelar inscrição
      </a>{' '}
      ·{' '}
      <a href="#" style={{ color: 'var(--text-muted)', textDecoration: 'underline' }}>
      ...
      <section style={{ padding: '140px 32px 100px', textAlign: 'center' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            E-mails que as
            <br />
            pessoas <em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>abrem.</em>
          </h1>
          <p
          ...
          >
            Boas-vindas, verificação, recibos, envio, alertas, redefinição de senha, convites. 8
        ...
        >
          ...
          <div className="reveal">
            <SH
              ...
              sub="Primeira impressão na caixa de entrada."
            />
            <Frame de="APEX <ola@apex.io>" assunto="Bem-vindo ao APEX — vamos começar">
              ...
              >
                Você acaba de se juntar a 12.000+ times que entregam produtos melhores com menos
                esforço. Veja como aproveitar ao máximo sua primeira semana:
              </p>
              <Notif
                icon="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"
                bg="rgba(99,107,240,0.1)"
                title="Configure seu workspace"
                desc="Crie seu primeiro projeto e convide seu time."
              />
              <Notif
                icon="M22 12l-4 0l-3 9l-6-18l-3 9l-4 0"
                bg="rgba(52,211,153,0.1)"
                title="Conecte suas ferramentas"
                desc="Integre com GitHub, Slack e Figma em um clique."
              />
              <Notif
                icon="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 6v6l4 2"
                bg="rgba(251,191,36,0.1)"
                title="Agende um tour"
                desc="15 minutos com nosso time. Mostramos os atalhos."
              />
              <div style={{ marginTop: 20 }}>
                <a href="#" className="em-btn">
                  Ir para o dashboard
                </a>
              </div>
              <Rodape />
          ...
          {/* 02 — Verificação */}
          <div className="reveal">
            <SH num="02" title="Código de verificação." sub="Claro, escaneável, uma ação." />
            <Frame de="APEX <seguranca@apex.io>" assunto="Seu código de verificação: 847291">
              <div style={{ textAlign: 'center' }}>
                <Logo />
                <h1
                  style={{ fontSize: 24, fontWeight: 600, marginBottom: 12, color: 'var(--text)' }}
                >
                ...
                >
                  Digite este código para confirmar seu endereço de e-mail. Ele expira em 10
                  minutos.
                </p>
                <div
                  style={{
          ...
          <div className="reveal">
            <SH num="03" title="Recibo de pedido." sub="Cada detalhe, claramente estruturado." />
            <Frame de="APEX Store <pedidos@apex.io>" assunto="Pedido confirmado — #ORD-2026-1847">
              <Logo />
              <h1 style={{ fontSize: 24, fontWeight: 600, marginBottom: 12, color: 'var(--text)' }}>
                Pedido confirmado.
              </h1>
              <p style={{ fontSize: 15, color: 'var(--text-secondary)', marginBottom: 24 }}>
                Obrigado pela compra, Ana. Aqui está o que você pediu:
              </p>
              {[
                {
                  name: 'Vaso Cerâmico Midnight',
                  variant: 'Tamanho M · Preto Fosco · Qtd: 1',
                  price: 'R$ 489',
                },
                { name: 'Manta de Linho', variant: 'Natural · King · Qtd: 2', price: 'R$ 680' },
              ].map((item) => (
                <div
                  key={item.name}
                  style={{
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>{item.variant}</div>
                  </div>
                  <div
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: 13,
                    color: l === 'Desconto' ? 'var(--success)' : 'var(--text-muted)',
                    marginBottom: 6,
                  }}
                >
                  <span>{l}</span>
              ...
              >
                <span>Total</span>
                <span>R$ 1.052,10</span>
              </div>
              <a href="#" className="em-btn">
                Rastrear seu pedido
              </a>
              <p style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 8 }}>
                Pedido #ORD-2026-1847 · Pago com Visa ····4242
              </p>
          ...
          <div className="reveal">
            <SH
              ...
              sub="Visualização de progresso. Onde está meu pacote?"
            />
            <Frame de="APEX Store <envio@apex.io>" assunto="Seu pedido está a caminho!">
              ...
              <p style={{ fontSize: 15, color: 'var(--text-secondary)', marginBottom: 4 }}>
                Entrega estimada:{' '}
                <strong style={{ color: 'var(--text)' }}>22 de março de 2026</strong>
              </p>
              <div style={{ display: 'flex', gap: 0, margin: '20px 0' }}>
                {[
                  { l: 'Pedido', done: true },
                  { l: 'Embalado', done: true },
                  { l: 'Enviado', current: true },
                  { l: 'Entregue' },
                ].map((s, i) => (
                  <div key={s.l} className={`ship-step${s.done ? ' done' : ''}`}>
                    <div
                      style={{
                        ...
                        height: 28,
                        borderRadius: '50%',
                        border: `2px solid ${s.done ? 'var(--success)' : s.current ? 'var(--accent)' : 'var(--border)'}`,
                        ...
                        fontSize: 10,
                        fontWeight: 600,
                        color: s.done ? 'white' : s.current ? 'var(--accent)' : 'var(--text-muted)',
                        margin: '0 auto 8px',
                        position: 'relative',
                        zIndex: 1,
                      }}
              ...
              <p style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 8 }}>
                Rastreio: <span style={{ fontFamily: 'monospace' }}>BR1234567890</span>
              </p>
              <a href="#" className="em-btn">
                Rastrear pacote
              </a>
          ...
          <div className="reveal">
            <SH
              ...
              sub="Segurança em primeiro lugar. Urgência clara."
            />
            <Frame de="APEX <seguranca@apex.io>" assunto="Redefina sua senha">
              ...
              >
                Recebemos um pedido para redefinir sua senha. Clique abaixo para escolher uma nova.
          ...
          <div className="reveal">
            <SH num="06" title="Convite para time." sub="Pessoal. Caloroso. Acionável." />
            <Frame de="APEX <times@apex.io>" assunto="Ana Souza convidou você para a Forma">
              ...
              <div style={{ textAlign: 'center', marginBottom: 24 }}>
                ...
                <h1
                  style={{ fontSize: 24, fontWeight: 600, marginBottom: 8, color: 'var(--text)' }}
                >
                  Entre para o time Forma.
                </h1>
                <p style={{ fontSize: 15, color: 'var(--text-secondary)' }}>
                  Ana Souza convidou você para colaborar na Forma.
                </p>
              </div>
              <div style={{ display: 'flex', justifyContent: 'center', gap: 8 }}>
                ...
                <a href="#" className="em-btn em-btn-ghost">
                  Recusar
                </a>
              </div>
              <Rodape />
          ...
          {/* 07 — Pagamento falhou */}
          <div className="reveal">
            <SH num="07" title="Pagamento falhou." sub="Alerta sem alarme." />
            <Frame de="APEX <cobranca@apex.io>" assunto="Ação necessária: pagamento falhou">
              ...
              >
                ...
                <p style={{ fontSize: 14, color: 'var(--text-secondary)' }}>
                  Não conseguimos processar seu pagamento do plano Pro (R$ 149/mês).
                </p>
              </div>
              <a href="#" className="em-btn">
          ...
          {/* 08 — Resumo semanal */}
          <div className="reveal">
            <SH num="08" title="Resumo semanal." sub="Resumo. Não ruído." />
            <Frame de="APEX <resumo@apex.io>" assunto="Sua semana na Forma — 17 a 23 de março">
              <Logo />
              <h1 style={{ fontSize: 24, fontWeight: 600, marginBottom: 16, color: 'var(--text)' }}>
