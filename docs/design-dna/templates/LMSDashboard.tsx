...
const COURSES: Course[] = [
  {
    ...
    category: "Design",
    description: "Build scalable design systems from scratch. Tokens, components, documentation.",
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Advanced type-level programming. Generics, mapped types, conditional types.",
    level: "Intermediate",
  ...
  },
  {
    ...
    description: "State management, code splitting, performance. Production patterns that scale.",
    level: "Advanced",
...
function CourseCard({ course }: { course: Course }) {
  return (
    <Card>
      ...
      <Card.Body>
        <p className="text-[10px] uppercase tracking-[0.08em] font-medium mb-1.5" style={{ color: "var(--accent)" }}>
          {course.category}
        </p>
        <h3 className="text-[18px] font-semibold tracking-tight mb-1.5" style={{ color: "var(--text)" }}>
          {course.title}
        </h3>
...
export default function LMSDashboard() {
  ...
  const sidebarSections = [
    {
      items: [
        ...
        },
        {
          ...
          icon: (
            <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
              <path d="M3 17l4-6 4 3 4-8" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ),
        },
        {
          ...
          icon: (
            <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <path d="M6.5 13l-2 5 5.5-2 5.5 2-2-5" />
            </svg>
          ),
        },
      ],
  ...
  return (
    ...
    >
      ...
      {/* Lesson player */}
      <section id="lesson" className="mb-16">
        <SectionHeader label="Now Playing" title="Current lesson." subtitle="Design Systems Fundamentals · Module 1" />
        <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
          <Card hover={false}>
            ...
            <Card.Body>
              <h2 className="text-[18px] font-semibold tracking-tight mb-1" style={{ color: "var(--text)" }}>
                Lesson 3: Design Token Architecture
              </h2>
              <p className="text-[13px]" style={{ color: "var(--text-muted)" }}>
                Building a token system that scales across platforms and themes.
              </p>
            </Card.Body>
          </Card>
          <Card hover={false}>
            ...
            <Card key={stat.label}>
              <Card.Body className="text-center">
                <div className="flex justify-center mb-3">
                  <ProgressRing percentage={stat.percentage} size={64} />
                </div>
          ...
          {ACHIEVEMENTS.map(a => (
            <Card key={a.id} hover={a.earned}>
              <Card.Body className="text-center">
                ...
                <h4 className="text-[14px] font-semibold mb-0.5" style={{ color: a.earned ? "var(--text)" : "var(--text-muted)" }}>
                  {a.title}
                </h4>
