...
const features = [
  {
    ...
    desc: 'Large display type, weight contrast, letter-spacing precision. The font IS the design. No decoration needed when the words are beautiful.',
  },
  {
    num: '02',
    title: 'Space is intentional',
    desc: "Whitespace isn't empty. It's the most powerful element on the page. It gives everything room to breathe, to be noticed, to matter.",
  },
  {
    num: '03',
    title: 'Motion has meaning',
    desc: 'Nothing moves without purpose. Blur to focus on entrance. Subtle lift on hover. The interface responds to you, not performs for you.',
  },
];
const pricing = [
  {
    ...
    price: '$0',
    unit: '/mo',
    desc: 'For individuals exploring.',
    items: ['3 projects', 'Basic analytics', 'Community support'],
    featured: false,
  },
  {
    tier: 'Pro',
    ...
    items: ['Unlimited projects', 'Advanced analytics', 'Priority support', 'Custom integrations'],
    featured: true,
  },
  {
    tier: 'Enterprise',
    ...
    items: ['Everything in Pro', 'SSO & SAML', 'Dedicated support', 'SLA guarantee'],
    featured: false,
  },
];
const testimonials = [
  {
    text: 'This changed how I think about shipping products. The quality bar is non-negotiable now.',
    name: 'Ana Souza',
    role: 'Product Lead, Fintech',
    initials: 'A',
  },
  {
    text: 'Every interface we ship now feels intentional. The difference is night and day.',
    name: 'Marcus Chen',
    role: 'CTO, Series A Startup',
    initials: 'M',
  },
  {
    text: "I stopped asking 'is this good enough?' Now I ask 'is this beautiful?' That shift changes everything.",
    name: 'Julia Park',
    ...
    <div style={{ color: 'var(--text)', fontFamily: 'var(--font-body)', position: 'relative' }}>
      ...
      >
        ...
        >
          ...
          >
            Stop shipping interfaces. Start shipping experiences. Every pixel earns its place or it
            doesn't exist.
          </p>
          <a
            href="#features"
      ...
      <section id="features" style={{ padding: '160px 32px' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 80 }}>
            ...
            >
              Every feature earns its place. If it doesn&rsquo;t, it doesn&rsquo;t exist.
            </p>
          </div>
              ...
              <div key={f.num} className="feature-card">
                <div
                  style={{
                    fontSize: 48,
                    fontWeight: 700,
                    color: 'var(--feature-number-color, var(--border-hover))',
                    fontFamily: 'var(--font-display)',
                    marginBottom: 24,
                    letterSpacing: '-0.03em',
                  }}
        ...
        <div style={{ maxWidth: 1120, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 80 }}>
            ...
            <p style={{ fontSize: 17, color: 'var(--text-secondary)', fontWeight: 300 }}>
              No hidden fees. No calculator needed.
            </p>
          </div>
          <div
            ...
            {pricing.map((p) => (
              <div key={p.tier} className={`price-card reveal${p.featured ? ' featured' : ''}`}>
                ...
                >
                  {p.price}
                  {p.unit && (
                    <small style={{ fontSize: 16, fontWeight: 400, color: 'var(--text-muted)' }}>
                      {p.unit}
                    </small>
                  )}
                </div>
                ...
                <button
                  style={{
                    ...
                    color: p.featured ? 'var(--accent-contrast, white)' : 'var(--text)',
                    transition: 'all .25s',
                  }}
                >
                  {p.featured
      ...
      <section style={{ padding: '160px 32px' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <p style={{ fontSize: 17, color: 'var(--text-secondary)', fontWeight: 300 }}>
              Every metric earns its place. Nothing decorative.
            </p>
          </div>
          <div
            className="reveal reveal-delay-1"
        ...
        <div style={{ maxWidth: 1120, margin: '0 auto' }}>
          ...
          >
            ...
            >
              ...
              >
                Join teams that ship products people love. Free to start, no credit card.
              </p>
            </div>
            <div
              style={{
      ...
      >
        ...
        <div className="reveal" style={{ textAlign: 'center', position: 'relative' }}>
          ...
          <p style={{ fontSize: 18, color: 'var(--text-secondary)', fontWeight: 300 }}>
            Start shipping interfaces that people remember.
          </p>
          <a
            href="#"
            style={{
          ...
          >
            Start building <span style={{ fontSize: 18 }}>&rarr;</span>
          </a>
        </div>
      </section>
      ...
      <footer style={{ padding: '64px 32px 32px', borderTop: '1px solid var(--border)' }}>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.6, maxWidth: 240 }}>
              Design like Ive. Code like Torvalds.
              <br />
              Ship like Jobs.
            </p>
          </div>
        ...
        >
          <p style={{ fontSize: 12, color: 'var(--text-muted)' }}>
            &copy; 2026 Lucas Bueno &amp; Claude. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
