...
const articles = [
  {
    ...
    desc: 'The difference between good and great is in the details nobody notices consciously.',
    author: 'Ana Souza',
    initials: 'AS',
    date: 'Mar 18 · 5 min',
  },
  {
    ...
    desc: 'The courage to delete features is the hardest skill in product development.',
    author: 'Marcus Chen',
    initials: 'MC',
    date: 'Mar 17 · 6 min',
  },
  {
    cat: 'Philosophy',
    title: 'Simplicity is not the absence of complexity.',
    desc: "It's the result of understanding it deeply enough to remove what doesn't serve the user.",
    author: 'Julia Park',
    initials: 'JP',
    date: 'Mar 16 · 4 min',
  },
...
export default function BlogLayout() {
    ...
    <div style={{ color: 'var(--text)', fontFamily: 'var(--font-body)', position: 'relative' }}>
      ...
      <section style={{ padding: '140px 32px 100px', textAlign: 'center' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            Typography-first reading experience. Every word has room.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            ...
            <div>
              ...
              >
                The invisible rules that make design feel intentional.
              </h1>
              <p
                style={{
                  fontSize: 17,
              ...
              >
                Design systems aren&rsquo;t about consistency for its own sake. They&rsquo;re about
                building trust through predictability — and then knowing exactly when to break the
                pattern.
              </p>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            {articles.map((a, i) => (
              <div
                key={a.title}
                className={`article-card reveal${i > 0 ? ` reveal-delay-${i}` : ''}`}
              >
                <div
                ...
                <div style={{ padding: '20px 0' }}>
                  ...
                  <div style={{ marginTop: 16 }}>
                    <Author initials={a.initials} name={a.author} date={a.date} />
                  </div>
                </div>
              </div>
            ))}
      ...
      <section style={{ padding: '100px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            >
              Typography that respects your attention.
            </p>
          </div>
          <div className="reveal reveal-delay-1" style={{ maxWidth: 680, margin: '0 auto' }}>
            ...
            >
              ...
              <span
                style={{ fontFamily: 'var(--font-sans)', fontSize: 12, color: 'var(--text-muted)' }}
              >
                8 min read
              </span>
            </div>
            <div style={{ fontSize: 18, lineHeight: 1.8, color: 'var(--text-secondary)' }}>
              <p style={{ marginBottom: 24 }}>
                There&rsquo;s a reason certain interfaces feel right the moment you see them.
                It&rsquo;s not the colors, the fonts, or the animations — it&rsquo;s the system
                behind them. The invisible rules.
              </p>
              <h2
                style={{
                  fontFamily: 'var(--font-display)',
              ...
              <p style={{ marginBottom: 24 }}>
                Whitespace is the most misunderstood element in design. Stakeholders see it as waste
                — &ldquo;can&rsquo;t we put something there?&rdquo; But whitespace is what gives
                every other element room to be noticed. It&rsquo;s the silence between notes that
                makes music.
              </p>
              <blockquote
                style={{
              ...
              <p style={{ marginBottom: 24 }}>
                This is the foundational insight. Every element on a page creates cognitive load.
                Every color, every border, every shadow demands a fraction of attention. The
                designer&rsquo;s job is to ruthlessly minimize that load while maximizing clarity.
              </p>
              <h2
                style={{
                  fontFamily: 'var(--font-display)',
              ...
              <p style={{ marginBottom: 24 }}>
                When the type is right, you don&rsquo;t need decoration. A 56px serif headline with{' '}
                <code
                  style={{
                ...
                creates more visual impact than any gradient or illustration.
              </p>
              <pre
                style={{
                  background: 'var(--bg-surface)',
  ...
  line-height: 1.1;
              ...
              <p style={{ marginBottom: 24 }}>
                The font IS the design. When you get typography right, everything else falls into
                place.
              </p>
            </div>
          </div>
