  ...
  return (
    ...
    >
        ...
        {product.badge && (
          <span
            style={{
              ...
              fontWeight: 600,
              background:
                product.badgeType === 'sale' ? 'var(--destructive,#f87171)' : 'var(--accent)',
              color: 'white',
            }}
          >
            {product.badge}
      ...
      <div style={{ padding: 16 }}>
        ...
        <h3 style={{ fontSize: 14, fontWeight: 500, letterSpacing: '-0.01em', marginBottom: 6 }}>
          {product.name}
        </h3>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
          ...
          {product.originalPrice && (
            <span
              style={{ fontSize: 13, color: 'var(--text-muted)', textDecoration: 'line-through' }}
            >
              {product.originalPrice}
            </span>
          )}
      ...
      >
        <button
          ...
          style={{
            width: '100%',
            padding: '10px',
            background: added ? 'var(--accent)' : 'var(--cta-bg,white)',
            color: added ? 'white' : 'var(--cta-text,#08080a)',
            border: 'none',
...
function CheckoutSteps() {
  return (
    <div
      className="reveal"
      style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: 48 }}
    >
      {STEPS.map((step, i) => (
          ...
          {i > 0 && (
            <div
              style={{
                ...
                height: 1,
                background:
                  STEPS[i - 1].state === 'done' ? 'var(--success,#34d399)' : 'var(--border)',
              }}
            />
          )}
          <div
            style={{
              ...
              padding: '12px 16px',
              fontSize: 13,
              color: step.state === 'active' ? 'var(--text)' : 'var(--text-muted)',
            }}
          >
            <div
              style={{
                ...
                height: 28,
                borderRadius: '50%',
                border: `1px solid ${step.state === 'done' ? 'var(--success,#34d399)' : step.state === 'active' ? 'var(--accent)' : 'var(--border)'}`,
                background:
                  step.state === 'done'
                    ? 'var(--success,#34d399)'
                    : step.state === 'active'
                      ? 'var(--accent)'
                      : 'none',
                color: step.state ? 'white' : 'var(--text)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: 12,
      ...
      <div style={{ color: 'var(--text)', fontFamily: 'var(--font-body)', position: 'relative' }}>
        ...
        <section style={{ textAlign: 'center', padding: '160px 32px 80px' }}>
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M60 60 V44 C60 30 72 20 80 20 C88 20 100 30 100 44 V60"
                stroke="var(--text-secondary)"
                strokeWidth="1.5"
                fill="none"
                strokeLinecap="round"
              ...
              <path
                d="M80 88 L82 93 L88 93 L83 97 L85 102 L80 99 L75 102 L77 97 L72 93 L78 93 Z"
                fill="var(--accent)"
                opacity="0.6"
              />
            </svg>
          ...
          <div className="reveal reveal-delay-1">
            ...
            >
              Shopping that <em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>feels</em>{' '}
              right.
            </h1>
            <p style={{ fontSize: 17, color: 'var(--text-secondary)', fontWeight: 300 }}>
              Product cards, cart, checkout. Every detail matters.
            </p>
          </div>
        </section>
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      'radial-gradient(circle at 30% 40%, var(--accent-glow,rgba(99,107,240,0.12)) 0%, transparent 50%)',
                  }}
                />
                <span style={{ fontSize: 14, color: 'var(--text-muted)', zIndex: 1 }}>
                  Product photography
                </span>
              </div>
              <div className="reveal reveal-delay-2">
                ...
                >
                  Hand-thrown stoneware with a matte black glaze. Each piece is unique — subtle
                  variations in texture and tone are part of the character.
                </p>
                  ...
                  {['S', 'M', 'L'].map((s) => (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 'var(--radius-sm,8px)',
                        background:
                          selectedSize === s ? 'var(--accent-glow,rgba(99,107,240,0.12))' : 'none',
                        color: selectedSize === s ? 'var(--accent)' : 'var(--text)',
                        fontSize: 13,
                        cursor: 'pointer',
                        transition: 'all 0.2s',
                        fontFamily: 'inherit',
        ...
        <section style={{ padding: '80px 32px', borderTop: '1px solid var(--border)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div
              className="cart-layout reveal reveal-delay-1"
              style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 48 }}
            >
              <div
                style={{
                  display: 'flex',
              ...
              >
                {[
                  {
                    name: 'Midnight Ceramic Vase',
                    variant: 'Size M · Matte Black',
                    price: '$89',
                    qty: 1,
                  },
                  { name: 'Linen Throw Blanket', variant: 'Natural · King', price: '$124', qty: 2 },
                  {
                    name: 'Copper Pour-Over Set',
                    variant: 'Brushed Copper',
                    price: '$124',
                    qty: 1,
                  },
                ].map((item) => (
              ...
              >
                ...
                {[
                  { label: 'Subtotal', value: '$337' },
                  { label: 'Discount', value: '-$27', accent: true },
                  ...
                  >
                    <span>{row.label}</span>
                    <span style={row.accent ? { color: 'var(--success,#34d399)' } : {}}>
                      {row.value}
                    </span>
                  </div>
                ))}
        ...
        <footer style={{ padding: '64px 32px 32px', borderTop: '1px solid var(--border)' }}>
          ...
          >
            <div>
              ...
              <p
                style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.6, maxWidth: 240 }}
              >
                Shopping patterns that convert. Every detail matters.
              </p>
            </div>
            <div style={{ display: 'flex', gap: 64, flexWrap: 'wrap' }}>
              {[
                { title: 'Patterns', links: ['Landing', 'CRM', 'E-Commerce'] },
                { title: 'Framework', links: ['GitHub', 'Documentation', 'Changelog'] },
              ].map((col) => (
