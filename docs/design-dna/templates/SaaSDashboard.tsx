...
const statsData = [
  {
    ...
    delta: '+12.5%',
    up: true,
    sparks: [30, 45, 38, 52, 48, 65, 58, 72, 64, 80],
  },
  {
    label: 'Users',
    value: '2,847',
    delta: '+8.2%',
    up: true,
    sparks: [40, 35, 50, 45, 55, 48, 60, 52, 65, 70],
  },
  {
    label: 'Conversion',
    value: '3.6%',
    delta: '-0.4%',
    up: false,
    sparks: [50, 48, 52, 45, 40, 42, 38, 36, 35, 34],
  },
  {
    label: 'Avg. Order',
    value: '$64',
    delta: '+2.1%',
    up: true,
    sparks: [35, 40, 38, 42, 44, 43, 48, 50, 52, 55],
  },
];
const chartBars = [
  42, 58, 35, 72, 55, 88, 65, 82, 48, 90, 68, 78, 52, 85, 60, 95, 70, 82, 55, 88, 72, 65, 80, 58,
];
const users = [
  {
    name: 'Ana Souza',
      ...
      <section style={{ padding: '140px 32px 100px', textAlign: 'center' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            Apps that respect
            <br />
            your <em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>time.</em>
          </h1>
          <p
          ...
          >
            Dashboard, tables, settings, empty states. Every pattern a SaaS app needs.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            <p style={{ fontSize: 17, color: 'var(--text-secondary)', fontWeight: 300 }}>
              Information hierarchy. No clutter.
            </p>
          </div>
          <AppFrame title="Dashboard — Acme Analytics">
            <div
              className="saas-app-layout"
              style={{ display: 'grid', gridTemplateColumns: '220px 1fr', minHeight: 560 }}
            >
              <div
              ...
              >
                ...
                <div className="saas-sidebar-item active">
                  <SidebarIcon d="M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z" />
                  Overview
                </div>
                <div className="saas-sidebar-item">
                  <SidebarIcon d="M22 12l-4 0l-3 9l-6-18l-3 9l-4 0" />
                  Analytics
                </div>
                <div className="saas-sidebar-item">
                  <SidebarIcon d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8" />
                  Users
                  <span
                    style={{
                      marginLeft: 'auto',
                ...
                <div className="saas-sidebar-item">
                  <SidebarIcon d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zM22 6l-10 7L2 6" />
                  Messages
                </div>
                <div
                  style={{
                ...
                <div className="saas-sidebar-item">
                  <SidebarIcon d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                  Preferences
                </div>
              </div>
                      ...
                      {['7d', '30d', '90d'].map((t, i) => (
                        <button
                          ...
                          style={{
                            ...
                            fontSize: 12,
                            border: 'none',
                            background: i === 0 ? 'var(--accent-glow)' : 'none',
      ...
      <section style={{ padding: '100px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            <p style={{ fontSize: 17, color: 'var(--text-secondary)', fontWeight: 300 }}>
              Not spreadsheets. Information with hierarchy.
            </p>
          </div>
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  {['Profile', 'Notifications', 'Security', 'Billing', 'Team'].map((item, i) => (
                    <div key={item} className={`settings-nav-item${i === 0 ? ' active' : ''}`}>
                      {item}
                    </div>
                  ))}
                </div>
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: '50%',
                          background:
                            'linear-gradient(135deg, var(--accent-glow), var(--bg-surface))',
                    ...
                    {[
                      {
                        ...
                        desc: 'Get notified about new activity',
                        on: true,
                      },
