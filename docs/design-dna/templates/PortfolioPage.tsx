...
const PROJECTS: Project[] = [
  {
    ...
    description:
      'Built a comprehensive design system from scratch for a Series B SaaS. 120+ components, 5 themes, full a11y compliance.',
    tags: ['Figma', 'React', 'TypeScript'],
    tall: true,
  },
  {
    id: 'pr2',
    title: 'Relay — Real-time Collab',
...
const SERVICES = [
  {
    ...
    desc: 'From research to polished interfaces. Figma, prototyping, design systems.',
  },
  {
    num: '02',
    title: 'Development',
    desc: 'Next.js, React, TypeScript. Production-grade code that performs.',
  },
  {
    num: '03',
    title: 'Brand Strategy',
    desc: 'Positioning, visual identity, tone of voice. Brands that resonate.',
  },
];
...
function ProjectCard({ p, delay }: { p: Project; delay?: number }) {
  ...
  return (
    ...
    >
      <div
        style={{
          aspectRatio: p.tall ? '16/14' : '16/10',
...
function ContactForm() {
  ...
  return (
    ...
    >
      ...
      {status === 'sent' ? (
        <p
          style={{ fontSize: 15, color: 'var(--success)', textAlign: 'center', padding: '24px 0' }}
        >
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 20 }}>
            <label htmlFor="cf-name" style={lbl}>
              Name
            </label>
            <input
              id="cf-name"
          ...
          <div style={{ marginBottom: 20 }}>
            <label htmlFor="cf-email" style={lbl}>
              Email
            </label>
            <input
              id="cf-email"
          ...
          <div style={{ marginBottom: 20 }}>
            <label htmlFor="cf-msg" style={lbl}>
              Message
            </label>
            <textarea
              id="cf-msg"
...
export default function PortfolioPage() {
  ...
  return (
    <div className="apex-enter" style={{ color: 'var(--text)', position: 'relative' }}>
      ...
      >
        <div>
          <p className="reveal" style={sectionLabel}>
            Portfolio
          </p>
          <h1
      ...
      <section id="work" style={sec}>
        <div style={inner}>
          ...
          >
            {PROJECTS.map((p, i) => (
              <ProjectCard key={p.id} p={p} delay={i > 0 ? i : undefined} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="about" style={sec}>
        ...
        >
          ...
          <div className="reveal reveal-delay-1">
            ...
            >
              We&apos;re a small studio that believes great products come from understanding people
              first, technology second. Every project starts with listening.
            </p>
            <p
              style={{
                fontSize: 16,
            ...
            >
              Based in São Paulo. Working globally.
            </p>
      ...
      <section id="services" style={sec}>
        <div style={inner}>
          ...
          <div
            className="sv-grid reveal reveal-delay-1"
            style={{
              display: 'grid',
