      ...
      <section style={{ padding: '140px 32px 100px', textAlign: 'center' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            Slides that
            <br />
            <em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>persuade.</em>
          </h1>
          <p
          ...
          >
            Pitch decks, keynotes, investor presentations. 10 slide types, each designed to make one
            point perfectly.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="pres-slide reveal">
            ...
            >
              The future of
              <br />
              work is <em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>async.</em>
            </h1>
            <p
              style={{
                fontSize: 18,
            ...
            >
              How distributed teams are outperforming co-located ones — and what it means for your
              company.
            </p>
            <div style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 32 }}>
              Acme Corp · Series B Pitch · March 2026
            </div>
            <SlideNum n={1} />
          </div>
          ...
          >
            ...
            >
              The <em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>problem.</em>
            </h2>
            <p style={{ fontSize: 16, color: 'var(--text-muted)', marginTop: 12 }}>
              Why traditional offices are failing knowledge workers.
            </p>
            <SlideNum n={2} />
          </div>
          ...
          <div className="pres-slide reveal" style={{ alignItems: 'center', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 64, marginTop: 32 }}>
              {[
                { v: '73%', l: 'Prefer remote work', c: 'var(--accent)' },
                { v: '2.4×', l: 'Productivity increase' },
                { v: '$21K', l: 'Saved per employee/year', c: 'var(--success)' },
              ].map((s) => (
          ...
          <div className="pres-slide reveal">
            ...
            <h2
              style={{ fontSize: 28, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 24 }}
            >
              Why async wins.
            </h2>
            <div
              className="pres-content-grid"
              ...
              {[
                {
                  n: '01',
                  t: 'Deep Work',
                  d: 'Uninterrupted blocks of focus time. No context switching. No meetings about meetings.',
                },
                {
                  n: '02',
                  t: 'Global Talent',
                  d: 'Hire the best person for the job, regardless of timezone.',
                },
                {
                  n: '03',
                  t: 'Written Culture',
                  d: 'Decisions documented by default. Institutional memory that scales.',
                },
                {
                  n: '04',
                  t: 'Work-Life Balance',
                  d: "People work when they're at their best. Retention follows.",
                },
              ].map((item) => (
                <div key={item.n}>
                  <div
                  ...
                  <h3 style={{ fontSize: 16, fontWeight: 600, marginBottom: 6 }}>{item.t}</h3>
          ...
          >
            ...
            >
              &ldquo;The future of work is not about where you work. It&rsquo;s about how clearly
              you think.&rdquo;
            </blockquote>
            <cite
              style={{
          ...
          {/* 6: Split Image+Text */}
          <div
            className="pres-slide pres-split reveal"
            style={{ flexDirection: 'row', gap: 0, padding: 0 }}
          >
            ...
            >
              ...
              />
              <span style={{ fontSize: 12, color: 'var(--text-muted)', position: 'relative' }}>
                Product screenshot
              </span>
            </div>
            <div
            ...
            >
              ...
              >
                Our platform replaces meetings with structured communication.
              </p>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[
                  'Threaded discussions with @mentions',
                  'Async video messages (no scheduling)',
                  'Decision logs with voting',
          ...
          <div className="pres-slide reveal">
            ...
            <div style={{ display: 'flex', gap: 0, marginTop: 24 }}>
              {[
                { q: 'Q1 2026', t: 'MVP launch', s: '1K users', done: true },
                { q: 'Q2 2026', t: 'Teams feature', s: '10K users', done: true },
                { q: 'Q3 2026', t: 'Enterprise', s: '50K target', done: false, n: '3' },
                { q: 'Q4 2026', t: 'AI features', s: '100K target', done: false, n: '4' },
              ].map((step, i) => (
                <div
                  key={step.q}
                  style={{ flex: 1, textAlign: 'center', position: 'relative', padding: '0 16px' }}
                >
                  {i > 0 && (
                    <div
                      style={{
                  ...
                  <div
                    style={{
                      ...
                      height: 32,
                      borderRadius: '50%',
                      border: `2px solid ${step.done ? 'var(--success)' : 'var(--accent)'}`,
                      ...
                      fontSize: 12,
                      fontWeight: 600,
                      color: step.done ? 'white' : 'var(--accent)',
                      margin: '0 auto 12px',
                      position: 'relative',
                      zIndex: 1,
                    }}
          ...
          <div className="pres-slide reveal" style={{ alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 48 }}>
              {[
                { name: 'Ana Souza', role: 'CEO & Design', bg: 'Ex-Stripe, RISD' },
                { name: 'Marcus Chen', role: 'CTO', bg: 'Ex-Google, MIT' },
                { name: 'Julia Park', role: 'Head of Product', bg: 'Ex-Linear, Stanford' },
              ].map((p) => (
          ...
          >
            ...
            >
              Ready to go <em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>async?</em>
            </h2>
            <p
              style={{
                fontSize: 18,
            ...
            >
              Let&rsquo;s build the future of work together.
            </p>
            <a
              href="#"
              style={{
