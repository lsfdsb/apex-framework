...
function IconBtn({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.color = 'var(--text,#ececf0)';
        e.currentTarget.style.background = 'var(--bg-surface,#19191d)';
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.color = 'var(--text-muted,#55555e)';
      ...
      {badge && (
        <span
          ...
          style={{
            ...
            border: '1.5px solid var(--bg-elevated,#111114)',
          }}
        />
      )}
    </button>
  ...
  return (
    <header aria-label="Page top bar" style={GLASS}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, minWidth: 0, flex: 1 }}>
              ...
              {breadcrumbs.map((b, i) => (
                <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                  ...
                  {b.href ? (
                    ...
                    <span style={{ fontSize: 12, color: 'var(--text-muted,#55555e)' }}>
                      {b.label}
                    </span>
                  )}
                </li>
        ...
        {breadcrumbs.length > 0 && (
          <span aria-hidden="true" style={{ color: 'var(--border,#222228)', fontSize: 14 }}>
            /
          </span>
        )}
        <h1
