      ...
      {open && (
        <div
          style={{
            ...
            zIndex: 50,
            overflow: 'hidden',
            animation: 'dd-in .2s cubic-bezier(0.22,1,0.36,1)',
          }}
          role="menu"
        >
            ...
            item.divider ? (
              ...
              <button
                ...
                style={{
                  ...
                  gap: 10,
                  fontSize: 13,
                  color: item.variant === 'destructive' ? 'var(--destructive)' : 'var(--text)',
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background =
                    item.variant === 'destructive' ? 'rgba(248,113,113,0.08)' : 'var(--bg-surface)';
                }}
                onMouseLeave={(e) => {
