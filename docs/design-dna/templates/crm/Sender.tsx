...
const WA_TEMPLATES = [
  {
    id: 'welcome',
    name: 'Boas-vindas',
    preview: 'Olá {{nome}}, bem-vindo(a) ao {{empresa}}! Como posso ajudar?',
  },
  {
    id: 'followup',
    name: 'Follow-up',
    preview: 'Oi {{nome}}, passando para saber se teve alguma dúvida sobre {{assunto}}.',
  },
  {
    id: 'proposal',
    name: 'Proposta',
    preview: '{{nome}}, sua proposta está pronta! Acesse: {{link}}',
  },
  {
    id: 'schedule',
    name: 'Agendamento',
    preview: '{{nome}}, confirmamos sua reunião para {{data}} às {{hora}}.',
  },
];
const MACROS = [
  ...
  return (
    <button
      ...
      style={{
        ...
        background: active
          ? `color-mix(in srgb, ${color || 'var(--accent)'} 10%, transparent)`
          : 'transparent',
    ...
    <div>
      ...
      >
        {(
          ...
          <Pill key={id} active={tab === id} color="var(--success)" onClick={() => setTab(id)}>
            {label}
          </Pill>
        ))}
      </div>
        ...
        <div style={{ padding: 32, textAlign: 'center' }}>
          ...
          >
            <div style={{ fontWeight: 500, color: 'var(--text-secondary)', marginBottom: 6 }}>
              Última ligação · 3 dias atrás · 12min
            </div>
            Discutiu proposta revisada. Elena animada com módulo de analytics. Board review na
            quinta.
          </div>
        </div>
      )}
      ...
      {tab === 'schedule' && (
        <div style={{ padding: 20 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              type="text"
              defaultValue="Follow-up proposal"
              style={{
                width: '100%',
                padding: '10px 14px',
                background: 'var(--bg)',
  ...
  return (
    <div>
      ...
      >
        ...
        >
          Que bom, Elena! Ajustei o escopo como combinamos.
        </div>
        <div
          style={{
            maxWidth: '80%',
      ...
      >
        <div
          style={{
            ...
            height: 8,
            borderRadius: '50%',
            background: CH.find((c) => c.id === channel)?.color,
          }}
        />
