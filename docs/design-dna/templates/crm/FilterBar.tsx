...
const FILTERS: FilterDef[] = [
  {
    id: 'stage',
    label: 'Stage',
    options: ['All stages', 'Lead', 'Qualified', 'Proposal', 'Closed'],
  },
  {
    id: 'owner',
    label: 'Responsável',
    options: ['Todos', 'Ana Souza', 'Marcus Chen', 'Julia Park'],
  },
  {
    id: 'source',
    label: 'Origem',
    options: ['Todas as origens', 'Inbound', 'Outbound', 'Indicação'],
  },
];
...
export default function FilterBar() {
  ...
  const removeFilter = (label: string) => setActive((prev) => prev.filter((f) => f !== label));
