...
const INITIAL_MESSAGES: Message[] = [
  ...
  { id: 2, role: 'user', text: "I can't find the export button." },
  {
    id: 3,
    role: 'agent',
    text: 'Great question! In the new version, it was moved to the top-right corner. Click the three-dot menu and you\'ll see "Export data".',
  },
    ...
    setTimeout(() => {
      ...
      setMessages((prev) => [
        ...prev,
        {
          id: Date.now() + 1,
          role: 'agent',
          text: 'Entendido! Vou verificar isso para você agora.',
        },
      ]);
    }, 1800);
  }
      ...
      <div ref={bodyRef} style={styles.body}>
        {messages.map((msg) => (
          <div
            ...
            style={{
              ...styles.msgBase,
              background: msg.role === 'agent' ? 'var(--bg-surface)' : 'var(--accent)',
              color: msg.role === 'agent' ? 'var(--text-secondary)' : 'white',
