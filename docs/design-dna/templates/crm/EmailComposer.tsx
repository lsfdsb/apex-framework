      ...
      <div style={{ padding: "12px 20px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 500 }}>
            {channel === "phone" ? "Call with Elena Rodriguez" : channel === "whatsapp" ? "Elena Rodriguez · +55 11 9xxxx" : "elena@seriesb.com"}
          </span>
        </div>
        {channel === "email" && (
      ...
      {channel === "phone" && (
        <div style={{ padding: 32, textAlign: "center" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 12 }}>
            <button style={{ padding: "10px 24px", borderRadius: "var(--radius-sm, 8px)", background: "var(--success)", color: "white", border: "none", fontSize: 14, fontWeight: 500, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>Call now</button>
