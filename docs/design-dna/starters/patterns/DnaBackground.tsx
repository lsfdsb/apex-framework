...
const SVG_PATTERNS: Record<string, PatternFn> = {
  dots: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="24" height="24" patternUnits="userSpaceOnUse"><circle cx="2" cy="2" r="1.2" fill="${c}" opacity="0.4"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  grid: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="48" height="48" patternUnits="userSpaceOnUse"><path d="M48 0L0 0 0 48" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.2"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  topo: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="200" height="200" patternUnits="userSpaceOnUse"><path d="M20,80Q60,20 100,80T180,80" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.2"/><path d="M20,130Q60,70 100,130T180,130" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.12"/><path d="M20,180Q60,120 100,180T180,180" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.08"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  circuit: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="80" height="80" patternUnits="userSpaceOnUse"><path d="M0,40L20,40 20,20 40,20M40,40L60,40 60,60 80,60M40,0L40,20M40,60L40,80" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.15"/><circle cx="20" cy="20" r="2.5" fill="${c}" opacity="0.2"/><circle cx="60" cy="60" r="2.5" fill="${c}" opacity="0.2"/><circle cx="40" cy="40" r="2" fill="${c}" opacity="0.25"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  hexagons: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="56" height="100" patternUnits="userSpaceOnUse" patternTransform="scale(0.6)"><path d="M28,2L52,17 52,47 28,62 4,47 4,17Z" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.15"/><path d="M28,52L52,67 52,97 28,112 4,97 4,67Z" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.1"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  crosses: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="32" height="32" patternUnits="userSpaceOnUse"><path d="M14,8L18,8 18,14 24,14 24,18 18,18 18,24 14,24 14,18 8,18 8,14 14,14Z" fill="${c}" opacity="0.1"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  diamonds: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M20,0L40,20 20,40 0,20Z" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.15"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  diagonals: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="16" height="16" patternUnits="userSpaceOnUse" patternTransform="rotate(45)"><line x1="0" y1="0" x2="0" y2="16" stroke="${c}" stroke-width="0.6" opacity="0.15"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  triangles: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="48" height="48" patternUnits="userSpaceOnUse"><path d="M24,4L44,44H4Z" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.12"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  constellation: (c, id) =>
  ...
  isometric: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="56" height="32" patternUnits="userSpaceOnUse"><path d="M28,0L56,16 28,32 0,16Z" fill="none" stroke="${c}" stroke-width="0.5" opacity="0.12"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  waves: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="200" height="40" patternUnits="userSpaceOnUse"><path d="M0,20Q50,0 100,20T200,20" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.15"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  dna: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="${id}" width="40" height="80" patternUnits="userSpaceOnUse"><path d="M0,0Q20,20 40,0M0,40Q20,60 40,40M0,80Q20,100 40,80" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.15"/><path d="M0,20Q20,0 40,20M0,60Q20,40 40,60" fill="none" stroke="${c}" stroke-width="0.6" opacity="0.08"/></pattern></defs><rect width="100%" height="100%" fill="url(#${id})"/></svg>`,
  noise: (c, id) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><filter id="${id}"><feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch"/><feColorMatrix type="saturate" values="0"/></filter></defs><rect width="100%" height="100%" filter="url(#${id})" opacity="0.05"/></svg>`,
};
  ...
  particles: (el) => {
    for (let i = 0; i < 40; i++) {
      ...
      Object.assign(p.style, {
        ...
        opacity: String(0.08 + Math.random() * 0.25),
  ...
  nebula: (el) => {
    ['var(--accent)', '#a855f7', '#ec4899', '#06b6d4', '#f59e0b'].forEach((color, i) => {
      ...
      Object.assign(blob.style, {
        ...
        background: color,
        pointerEvents: 'none',
        opacity: String(0.08 + Math.random() * 0.1),
        mixBlendMode: 'screen',
        top: Math.random() * 80 + '%',
        left: Math.random() * 80 + '%',
