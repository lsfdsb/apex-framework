        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="flex flex-col gap-6">
            ...
            {dictionary.web.contact.hero.benefits.map((benefit) => (
              <div className="flex flex-row items-start gap-6 text-left" key={benefit.title}>
          ...
          <div className="flex items-center justify-center">
            <div className="flex max-w-sm flex-col gap-4 rounded-md border p-8">
              ...
              <div className="grid w-full max-w-sm items-center gap-1">
                <Label htmlFor="picture">{dictionary.web.contact.hero.form.date}</Label>
                <Popover>
              ...
              <div className="grid w-full max-w-sm items-center gap-1">
                <Label htmlFor="picture">{dictionary.web.contact.hero.form.resume}</Label>
                <Input id="picture" type="file" />
              </div>

              <Button className="w-full gap-4">
                {dictionary.web.contact.hero.form.cta} <MoveRight className="h-4 w-4" />
              </Button>
            </div>
          </div>
        </div>
